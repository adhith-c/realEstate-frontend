...
function ConfirmModal({ modalState, close, confirm }) {
  return (
    <div className="w-[50rem] flex items-center justify-center">
      <Modal
        ...
        <div className="w-full h-[13rem] overflow-scroll scrollbar-hide">
          <div
            id="popup-modal"
            tabindex="-1"
              ...
              <div class="relative  rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                  ...
                  <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Are you sure you want to mark sold this property?
                  </h3>
                  <button
                    data-modal-hide="popup-modal"
                    type="button"
